...
import { accountingControlRoomView, accountingReportsIndexView, accountingReportsDetailView, } from "./accounting-dashboard";
    ...
    resources: [
        ...
        },
        {
            ...
            seed: (i) => ({
                ...
                name: pick(["Cash", "Accounts Receivable", "Inventory", "Accounts Payable", "Sales Revenue", "COGS", "Rent", "Utilities"], i),
        ...
        },
        {
            ...
            seed: (i) => ({
                code: `CC-${1000 + i * 5}`,
                name: pick(["Corporate", "R&D", "GTM", "Support Ops", "Infra", "People", "Exec", "Shared Services", "Field Sales", "Inside Sales", "Partner Alliance", "Product Marketing", "Demand Gen", "Content"], i),
