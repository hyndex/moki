...
import { communityFeedView, communityModerationView, communitySpaceDetailView, communitySpacesView, } from "./community-pages";
import { POSTS, SPACES, MODERATION } from "./data";
import { communityControlRoomView, communityReportsIndexView, communityReportsDetailView, } from "./community-dashboard";
...
spaceResource.__seed = SPACES.map(({ color: _c, ...rest }) => rest);
