...
import { crmActivityView, crmContactDetailView, crmContactsView, crmOverviewView, crmPipelineView, crmSegmentsView, } from "./crm-pages";
...
contactResource.__seed = CONTACTS.map(({ activityTrend: _t, ...rest }) => rest);
