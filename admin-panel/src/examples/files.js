    ...
    resources: [
        ...
        },
        {
            ...
            seed: (i) => ({
                ...
                label: pick(["Local filesystem", "Cloudflare R2 (cold)", "Wasabi archive", "MinIO (dev)"], i),
                provider: pick(["-", "cloudflare-r2", "wasabi", "minio"], i),
                endpoint: pick(["-", "https://acct.r2.cloudflarestorage.com", "https://s3.us-east-1.wasabisys.com", "http://localhost:9000"], i),
