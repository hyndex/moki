...
export const pluginInspectorPlugin: PluginV2 = definePlugin({
  manifest: {
    id: "shell.plugin-inspector",
    version: "1.0.0",
    label: "Plugin Inspector",
    description:
      "Manage installed plugins — view manifests, registries, contributions, install from URL, and reload or uninstall at runtime.",
    icon: "Package",
    requires: {
      shell: "*",
