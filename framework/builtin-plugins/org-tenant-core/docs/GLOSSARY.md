...
- `billingPlan`: Add the field meaning and how operators use it.
- `createdAt`: Add the field meaning and how operators use it.
- `displayName`: Add the field meaning and how operators use it.
- `id`: Add the field meaning and how operators use it.
- `slug`: Add the field meaning and how operators use it.
