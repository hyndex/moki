# Admin Widgets Agent Context

Package/app id: `admin-widgets`
Target type: `package`  | Package kind: `framework-library`
Location: `framework/libraries/admin-widgets`

## Purpose

Dashboard DSLs, saved questions, and widget primitives for the admin desk.
