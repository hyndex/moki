...
Package/app id: `@platform/plugin-solver`
Target type: `package`  | Package kind: `framework-core`
Location: `framework/core/plugin-solver`

## Purpose

Document what the app at framework/core/plugin-solver exists to demonstrate or operate.
