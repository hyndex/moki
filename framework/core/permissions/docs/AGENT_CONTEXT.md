...
Package/app id: `@platform/permissions`
Target type: `package`  | Package kind: `framework-core`
Location: `framework/core/permissions`

## Purpose

Document what the app at framework/core/permissions exists to demonstrate or operate.
